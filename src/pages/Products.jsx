  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const fakeProducts = [
        ...
        { id: 3, title: "Llave Inglesa", image: llaveInglesa, price: 300, description: "Llave ajustable para apretar o aflojar tuercas y tornillos." },
        { id: 4, title: "Taladro Eléctrico", image: taladro, price: 400, description: "Taladro eléctrico de alta potencia para perforar madera, metal y concreto." },
